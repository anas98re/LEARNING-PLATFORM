...
class TraditionalQuizFactory extends Factory

{
     ...
     * @var string
     */
    protected $model = \Modules\Sections\Entities\TraditionalQuiz::class;
    ...
    public function definition()
    {
        return [
            ...
            'correction_Ladder_file'=>$this->faker->fileExtension(),
