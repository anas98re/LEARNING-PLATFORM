...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('traditional_quizzes', function (Blueprint $table) {//traditional quiz questions
            $table->id();
            ...
            $table->text('correction_Ladder_file');
    ...
    {
        Schema::dropIfExists('traditional_quizzes');
    }
};
