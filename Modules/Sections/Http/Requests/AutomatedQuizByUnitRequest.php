...
class AutomatedQuizByUnitRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'unit_id' => 'required|exists:automated_quizzes,unit_id',
    ...
    public function messages()
    {
        if (App::getLocale() == 'ar') {
            return [
                ...
                'unit_id.exists' => 'يجب أن تكون الوحدة موجودة لهذا الامتحان المؤتمت',
